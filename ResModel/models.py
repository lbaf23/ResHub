...
class Paper(models.Model):
    ...
    ReadNum = models.IntegerField(auto_created=0)
    LinkNum = models.CharField(max_length=200,auto_created=0)
    CollectionNum = models.IntegerField(auto_created=0)
    IsUserUpload = models.BooleanField(null=False,auto_created=False)
    ...
    LitType = models.IntegerField(auto_created=1)
class Patent(models.Model):
    ...
    LitType = models.IntegerField(auto_created=2)
class Project(models.Model):
    ...
    LitType = models.IntegerField(auto_created=3)
